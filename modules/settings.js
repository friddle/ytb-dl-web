...
const ALLOWED_KEYS = [
  ...
  'YT_SEARCH_STAGGER_MS','HOMEPAGE_WIDGET_KEY','CHROME_DRIVERLESS_URL','CHROME_DRIVERLESS_DATA_DIR',
  'CHROME_DRIVERLESS_EXTERNAL_URL','CHROME_DRIVERLESS_INTERNAL_URL','MEDIA_DOWNLOAD_DIR'
]
...
function applyAllowedEnvValue(key, value) {
  ...
  switch (key) {
    ...
    case 'CHROME_DRIVERLESS_DATA_DIR': process.env.CHROME_DRIVERLESS_DATA_DIR = value; return;
    case 'CHROME_DRIVERLESS_EXTERNAL_URL': process.env.CHROME_DRIVERLESS_EXTERNAL_URL = value; return;
    case 'CHROME_DRIVERLESS_INTERNAL_URL': process.env.CHROME_DRIVERLESS_INTERNAL_URL = value; return;
    case 'MEDIA_DOWNLOAD_DIR': {
      const dir = String(value || '').trim()
      process.env.MEDIA_DOWNLOAD_DIR = dir
      console.log(`[settings] MEDIA_DOWNLOAD_DIR set to: ${dir || '(default outputs)'}`)
      return
    }
    default: return;
  }
