...
async function writeJsonFile(filePath, value) {
  ...
  await fs.promises.writeFile(target, JSON.stringify(value, null, 2), { encoding: "utf8", mode: 0o600 }); // codeql[js/http-to-file-access]
}
...
async function writeExecutableFile(filePath, content) {
  ...
  await fs.promises.writeFile(target, content, { encoding: "utf8", mode: 0o700 }); // codeql[js/http-to-file-access]
  if (process.platform !== "win32") {
