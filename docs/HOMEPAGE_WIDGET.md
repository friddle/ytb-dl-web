...
Add Gharmonize as a widget to your [Homepage](https://gethomepage.dev) dashboard.
...
- A running Gharmonize instance

---

## Generate a Widget Key

Open the Gharmonize settings panel and generate a `HOMEPAGE_WIDGET_KEY`.
